...
const FeatureCard = ({
  ...
  <div
    className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 animate-fadeInUp"
...
const InfoBox = ({
  ...
  <div
    className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl p-8 border-l-4 border-primary animate-fadeInLeft"
  ...
  >
    ...
    <div className="text-lg text-foreground/80 leading-relaxed">{children}</div>
  </div>
);
      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
          <div
            ...
            style={{ animation: "slideInUp 1.2s ease-out 0.5s both" }}
          >
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <section className="mb-20">
          ...
          >
            ...
            <p className="text-xl text-gray-600">
              Những thành phần quan trọng tạo nên website học thuật của chúng
              tôi
            </p>
          </div>
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <FeatureCard
              ...
              description="Các kiến thức được tổng hợp từ các nguồn uy tín, đảm bảo tính chính xác và cập nhật về quan điểm và tư tưởng của Hồ Chí Minh."
            />
          </div>
        </section>
        ...
        <section className="mb-20">
          ...
          >
            ...
            <p className="text-xl text-gray-600">
              Các công cụ hiện đại giúp tối ưu hóa quy trình phát triển
            </p>
          </div>
          <div className="grid md:grid-cols-2 gap-8">
            {/* ChatGPT Card */}
            <div
              className="bg-white rounded-2xl p-10 shadow-xl hover:shadow-2xl transition-all duration-300 animate-fadeInUp"
            ...
            >
              ...
              <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-6 rounded-xl border-l-4 border-blue-600">
                <p className="text-sm text-foreground/70 mb-2">
                  <strong>
                    Ví dụ — Xây dựng nội dung trình bày Tư tưởng Hồ Chí Minh
                  </strong>
                </p>
                <p className="text-sm mb-2">
                  <strong>PROMPT:</strong> Soạn nội dung Chương III: Tư tưởng Hồ
                  Chí Minh về độc lập dân tộc gắn liền với chủ nghĩa xã hội;
                  trình bày theo dạng bullet point, bảng so sánh (Mác–Ăngghen,
                  Quốc tế Cộng sản, Hồ Chí Minh), văn phong ngắn gọn, dễ thuyết
                  trình.
                </p>
                <p className="text-sm mb-2">
                  <strong>KẾT QUẢ AI:</strong> Sinh nội dung lý luận mạch lạc,
                  hệ thống hóa quan điểm của Hồ Chí Minh; tạo bảng so sánh rõ
                  ràng về con đường cách mạng.
                </p>
              </div>
            </div>
            ...
            >
              ...
              <div className="bg-gradient-to-r from-purple-50 to-pink-50 p-6 rounded-xl border-l-4 border-purple-600">
                <p className="text-sm text-foreground/70 mb-2">
                  <strong>
                    Ví dụ — Thiết kế giao diện trình bày Tư tưởng Hồ Chí Minh
                  </strong>
                </p>
                <p className="text-sm mb-2">
                  <strong>PROMPT:</strong> Thiết kế giao diện web trình bày nội
                  dung Tư tưởng Hồ Chí Minh: tiêu đề chương, mục lớn, bullet
                  point và bảng so sánh; phong cách trang trọng, dễ đọc, phù hợp
        ...
        <section className="mb-20 space-y-8">
          ...
          >
            <h2 className="text-4xl sm:text-5xl font-bold text-gray-900 mb-4">
              Tài Liệu & Cam Kết Học Thuật
            </h2>
            <p className="text-xl text-gray-600">
              Đảm bảo tính chính xác, minh bạch và trách nhiệm
            </p>
          </div>
          ...
          >
            <p className="mb-4">
              Nội dung được tổng hợp, hệ thống hóa từ các nguồn học thuật và
              chính trị chính thống:
            </p>
            <ul className="list-disc list-inside space-y-2 pl-2">
              <li>
                <strong>Giáo trình Tư tưởng Hồ Chí Minh</strong>, Bộ Giáo dục và
                Đào tạo, NXB Chính trị Quốc gia Sự thật.
              </li>
              <li>
                <strong>Hồ Chí Minh Toàn tập</strong>, NXB Chính trị Quốc gia Sự
                thật.
              </li>
              <li>
                <strong>Văn kiện Đảng Cộng sản Việt Nam</strong> qua các kỳ Đại
                hội.
              </li>
            </ul>
          </InfoBox>
          ...
          >
            <p>
              ...
              <strong>
                mọi nội dung học thuật, cân bằng số liệu và kiểm tra
                đầu cuối
              </strong>{" "}
              đều do
              <strong>
          ...
          >
            ...
            <ol className="list-decimal list-inside space-y-3 pl-2">
              ...
              <li>
                Hiệu chỉnh và xác nhận lại các khái niệm quan điểm và tư tưởng của Hồ Chí Minh.
              </li>
              <li>
                Kiểm tra số liệu, trích dẫn và tính hợp lý của ví dụ
                minh họa.
              </li>
              <li>
